...
class InPerson extends StatelessWidget {
   InPerson({super.key});
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        children: [
          TextFormField(
            controller:eventController.eventNameOffline ,
        ...
        Row(
          ...
          TextFormField(
            maxLines: 3,
            // maxLength: 5,
          controller: eventController.addressOffline,
            decoration: InputDecoration(
              alignLabelWithHint: true,
          ...
          SizedBox(height:15.h),
          TextFormField(
            controller: eventController.eventLink,
            decoration: InputDecoration(
              alignLabelWithHint: true,
              contentPadding:  EdgeInsets.only(
                  left: 20.w,
          ...
          TextFormField(
            maxLines: 3,
            // maxLength: 5,
          controller: eventController.descriptionOffline,
            decoration: InputDecoration(
              alignLabelWithHint: true,
          ...
          SizedBox(height:15.h),
          TextFormField(
            controller: eventController.speakerOffline,
            decoration: InputDecoration(
              alignLabelWithHint: true,
              contentPadding:  EdgeInsets.only(
                  left: 20.w,
          ...
          bool result=    await eventController.offlinePost(
                  imagesPath: [
                    eventController.containerBack.value!
                  ],
                  photosName: ['image'],
                  eventLink: eventController.eventLink.text,
                  eventName: eventController.eventNameOffline.text,
                  eventTime: eventTime,
                  description: eventController.descriptionOffline.text,
                  speaker: eventController.speakerOffline.text,
          venue_address: eventController.addressOffline.text);
              if (result) {
                // Clear the data after successful post
                eventController.eventNameOffline.clear();
                eventController.descriptionOffline.clear();
                eventController.DateOffline.clear();
                eventController.TimeOffline.clear();
                eventController.addressOffline.clear();
                eventController.eventLink.clear();
                eventController.speakerOffline.clear();
                eventController.addressOffline.clear();
                eventController.containerBack.value = null;


                // Optionally reset the selected date and time to current
                eventController.setSelectedDate(DateTime.now());
                eventController.setSelectedTime(TimeOfDay.now());
